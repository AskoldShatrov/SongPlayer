    ...
    : QAbstractListModel{parent}
{
    ...
    connect(&m_mediaPlayer, &QMediaPlayer::positionChanged, this, &PlayerController::updatePosition);
    connect(&m_mediaPlayer, &QMediaPlayer::durationChanged, this, &PlayerController::updateDuration);

    addAudio("Baby Blizzard",
             "Baby B3ns",
             QUrl("qrc:/SongPlayer/assets/audio/mmm.mp3"),
             QUrl("qrc:/SongPlayer/assets/images/song1jpg.jpg"));

    addAudio("C418",
             "Aria Math",
             QUrl("qrc:/SongPlayer/assets/audio/mmmm.mp3"),
             QUrl("qrc:/SongPlayer/assets/images/song2.jpg"),
             QUrl("qrc:/SongPlayer/assets/videos/mmm.mp4"));
}
